...
<body class="bg-gray-50 antialiased">
    ...
    <!-- Sidebar -->
    <aside id="sidebar"
        class="fixed left-0 top-0 z-40 h-screen w-64 transition-all duration-300 ease-in-out lg:translate-x-0 -translate-x-full bg-gradient-to-b from-gray-900 via-gray-900 to-gray-950 shadow-2xl">
        <!-- Sidebar Header -->
        <div class="flex items-center justify-between h-20 px-6 border-b border-gray-800/50">
            <div class="flex items-center gap-3 sidebar-content">
                <div class="relative">
                    <div
                        class="flex items-center justify-center w-11 h-11 bg-gradient-to-br from-red-500 to-red-700 rounded-xl shadow-lg shadow-red-500/30">
        ...
        <nav class="flex flex-col h-[calc(100vh-5rem)] overflow-hidden">
            <div class="flex-1 overflow-y-auto px-3 py-6 space-y-8 custom-scrollbar">
                ...
                <div class="space-y-2">
                    ...
                    <a href="{{ route('qr-codes.index') }}" class="nav-item group">
                        <div class="nav-icon-wrapper">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="#" class="nav-item group">
                        ...
                        <span class="sidebar-text font-medium">Profiles</span>
                    </a>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <a href="{{ route('orders.index') }}" class="nav-item group">
                        <div class="nav-icon-wrapper">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('products.index') }}" class="nav-item group">
                        <div class="nav-icon-wrapper">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('bundles.index') }}" class="nav-item group">
                        <div class="nav-icon-wrapper">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <span class="sidebar-text font-medium">Bundles</span>
                    </a>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <a href="#" class="nav-item group">
                        ...
                        <span class="sidebar-text font-medium">Customers</span>
                    </a>
                </div>
            ...
            <div class="px-3 pb-4 border-t border-gray-800/50 pt-4 mt-auto">
                <div class="relative">
                    <div
                        class="flex items-center gap-3 p-3 rounded-xl bg-gray-800/50 hover:bg-gray-800 cursor-pointer transition-all duration-200 group sidebar-content">
                        <div class="relative flex-shrink-0">
                            <div
                                class="flex items-center justify-center w-11 h-11 bg-gradient-to-br from-red-500 to-red-700 rounded-xl text-white font-bold shadow-lg shadow-red-500/20">
                        ...
                        <div class="flex-1 min-w-0 sidebar-text">
                            ...
                            <p class="text-xs text-gray-400 truncate">{{ auth()->user()->email ?? 'admin@Najaah.com' }}
                            </p>
                        </div>
                        <svg class="w-5 h-5 text-gray-400 group-hover:text-gray-300 transition-colors flex-shrink-0 sidebar-text"
    ...
    <button onclick="collapseSidebar()" id="collapseBtn"
        class="hidden lg:flex fixed left-64 top-24 z-50 items-center justify-center w-7 h-7 bg-white border border-gray-200 rounded-full shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 group">
        <svg id="collapseIcon" class="w-4 h-4 text-gray-600 group-hover:text-gray-900 transition-all duration-300"
            fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <header class="sticky top-0 z-30 bg-white/80 backdrop-blur-xl border-b border-gray-200/80 shadow-sm">
            <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <!-- User Menu -->
                    <button
                        class="hidden sm:flex items-center gap-2 p-1.5 rounded-xl hover:bg-gray-100 transition-colors">
                        <div
                            class="w-9 h-9 bg-gradient-to-br from-red-500 to-red-700 rounded-xl flex items-center justify-center text-white text-sm font-bold shadow-lg shadow-red-500/20">
                            {{ substr(auth()->user()->name ?? 'A', 0, 1) }}
                        </div>
                    </button>
                </div>
    ...
    <div id="sidebarOverlay"
        class="fixed inset-0 bg-gray-900/60 backdrop-blur-sm z-30 lg:hidden hidden transition-opacity"
